...
## 3.1 График движения
 |Дата|День|Участок маршрута|Км|H+|H-|Hмакс|Нсон|Способ передвижения|
 |-|-|-|-|-|-|-|-|-|
|19.08|1|г. Минеральные Воды – погранзастава Хурзук|200|1290|-|1590|-|автотранспорт|
...
Итого активными способами передвижения (по GPS): 134.7 км/ 161.6 км (c учетом коэффициента 1.2), набор высоты 8860м м, сброс высоты 9090 м.
